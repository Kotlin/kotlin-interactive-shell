...
import lib.jline.internal.Curses;
import lib.jline.internal.NonBlockingInputStream;
import lib.jline.internal.Nullable;
...
import lib.jline.internal.Urls;
...
public class ConsoleReader implements Closeable
{
    ...
    private final List<lib.jline.console.completer.Completer> completers = new LinkedList<lib.jline.console.completer.Completer>();
     ...
     */
    public Collection<lib.jline.console.completer.Completer> getCompleters() {
    ...
    private lib.jline.console.history.History history = new lib.jline.console.history.MemoryHistory();

    public void setHistory(final lib.jline.console.history.History history) {
        this.history = history;
    }

    public lib.jline.console.history.History getHistory() {
        return history;
    }
    ...
    public int searchBackwards(String searchTerm, int startIndex, boolean startsWith) {
        ListIterator<lib.jline.console.history.History.Entry> it = history.entries(startIndex);
        while (it.hasPrevious()) {
            lib.jline.console.history.History.Entry e = it.previous();
            if (startsWith) {
    ...
    public int searchForwards(String searchTerm, int startIndex, boolean startsWith) {
        ...
        while (it.hasNext()) {
            lib.jline.console.history.History.Entry e = it.next();
            if (startsWith) {
                if (e.value().toString().startsWith(searchTerm)) {
                    return e.index();
                }
